...
namespace Shoply.Arguments.Argument.General.Filter
{
    ...
    public class FilterCriteria(string propertyName, EnumFilterOperator @operator, string? value, List<object>? listValue, string? minValue, string? maxValue)
    {
        public string PropertyName { get; private set; } = propertyName;
        public EnumFilterOperator Operator { get; private set; } = @operator;
        public string? Value { get; private set; } = value;
        public List<object>? ListValue { get; private set; } = listValue;
