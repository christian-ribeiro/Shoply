...
public class CustomerDTO : BaseDTO<InputCreateCustomer, InputUpdateCustomer, OutputCustomer, CustomerDTO, InternalPropertiesCustomerDTO, ExternalPropertiesCustomerDTO, AuxiliaryPropertiesCustomerDTO>, IBaseDTO<CustomerDTO, OutputCustomer>
{
    public CustomerDTO GetDTO(OutputCustomer output)
    {
        return new CustomerDTO
        {
            ...
            AuxiliaryPropertiesDTO = new AuxiliaryPropertiesCustomerDTO(output.ListCustomerAddress.Cast<CustomerAddressDTO>()).SetInternalData(output.CreationUser!, output.ChangeUser!)
        };
    }
    public OutputCustomer GetOutput(CustomerDTO dto)
    {
        return new OutputCustomer(dto.ExternalPropertiesDTO.Code, dto.ExternalPropertiesDTO.FirstName, dto.ExternalPropertiesDTO.LastName, dto.ExternalPropertiesDTO.BirthDate, dto.ExternalPropertiesDTO.Document, dto.ExternalPropertiesDTO.PersonType, dto.AuxiliaryPropertiesDTO.ListCustomerAddress.Cast<OutputCustomerAddress>())
