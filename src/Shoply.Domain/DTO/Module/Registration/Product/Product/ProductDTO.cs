...
public class ProductDTO : BaseDTO<InputCreateProduct, InputUpdateProduct, OutputProduct, ProductDTO, InternalPropertiesProductDTO, ExternalPropertiesProductDTO, AuxiliaryPropertiesProductDTO>, IBaseDTO<ProductDTO, OutputProduct>
{
    public ProductDTO GetDTO(OutputProduct output)
    {
        return new ProductDTO
        {
            ...
            AuxiliaryPropertiesDTO = new AuxiliaryPropertiesProductDTO(output.ProductCategory!, output.MeasureUnit!, output.Brand!, output.ListProductImage.Cast<ProductImageDTO>()).SetInternalData(output.CreationUser!, output.ChangeUser!)
        };
    }

    public OutputProduct GetOutput(ProductDTO dto)
    {
        return new OutputProduct(dto.ExternalPropertiesDTO.Code, dto.ExternalPropertiesDTO.Description, dto.ExternalPropertiesDTO.BarCode, dto.ExternalPropertiesDTO.CostValue, dto.ExternalPropertiesDTO.SaleValue, dto.ExternalPropertiesDTO.Status, dto.ExternalPropertiesDTO.ProductCategoryId, dto.ExternalPropertiesDTO.MeasureUnitId, dto.ExternalPropertiesDTO.BrandId, dto.InternalPropertiesDTO.Markup, dto.AuxiliaryPropertiesDTO.ProductCategory!, dto.AuxiliaryPropertiesDTO.MeasureUnit!, dto.AuxiliaryPropertiesDTO.Brand!, dto.AuxiliaryPropertiesDTO.ListProductImage.Cast<OutputProductImage>())
