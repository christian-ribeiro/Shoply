...
public class MapperEntityDTO : Profile
{
    public MapperEntityDTO()
    {
        ...
        CreateMap<ProductImage, InternalPropertiesProductImageDTO>()
            .ConstructUsing(src => new InternalPropertiesProductImageDTO())
            .ReverseMap();
        
        CreateMap<ProductImage, ExternalPropertiesProductImageDTO>()
            .ConstructUsing(src => new ExternalPropertiesProductImageDTO(src.FileName, src.FileLength, src.ImageUrl, src.ProductId))
            .ReverseMap();
        
        CreateMap<ProductImage, AuxiliaryPropertiesProductImageDTO>()
